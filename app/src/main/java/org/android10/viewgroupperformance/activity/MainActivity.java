...
import org.android10.viewgroupperformance.HttpClientUtil;
import org.android10.viewgroupperformance.OkHttpUtil;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpClientUtil.get();
        for (int i = 0; i < 2; i++) {
            Log.d(TAG, "onData: " + transData(String.valueOf(i)));
        }
    }

    private String transData(String string) {
        return "hi " + string;
    }
